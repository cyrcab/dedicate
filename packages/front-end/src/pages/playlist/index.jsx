...
const rows2 = [
  {
    ...
    Style: 'Techno / House / Electro',
    Description:
      'Lorem bk lijazljbdc lqjb ljzebf lezfh lzkjbc lk bzl czkjb clejkbzcl',
  },
  {
    id: 2,
    EventName: 'RapRap',
...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-thumb': {
    backgroundColor:
      theme.palette.mode === 'dark' ? '#003892' : 'rgba(202, 69, 186);',
    width: 32,
    height: 32,
    '&:before': {
      content: "''",
    ...
    <div>
      <div className="playlist">
        ...
        <FormControlLabel
          ...
          label={<div className="switch-label"></div>}
